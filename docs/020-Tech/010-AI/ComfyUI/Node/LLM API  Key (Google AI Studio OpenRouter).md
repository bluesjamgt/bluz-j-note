...
- **目標：** 取得 `sk-or-...` 開頭的標準化 Key，並管理模型路由。
- **流程：**
...
- **進階設定 (BYOK - Bring Your Own Key)：**
    ...
    - 在 "Google AI Studio" 欄位貼上 `AIzaSy...` 原廠 Key。
...
|**API Key**|填入 `sk-or-...` (OpenRouter Key)|填入 `AIzaSy...` (Google Key)|
|**Model Name**|**必須加上廠商前綴**||
